classdef BaseZoom2 < handle
    ...
    methods
        function [h]=plot(obj, ax1, parameters) % 元波形のaxesに対して追加を行う
...
%             obj.axes1 = gca;
            ...
            if legendExist
                (obj.axes1.Legend.String); % legendを消す
        ...
        function connectAxesAndBox(obj, lineDirection)
            ...
            % insert lines
            obj.laxes = axes('Position', obj.axes1.Position);
            copyobj(get(obj.axes1, 'children'), obj.laxes)
            obj.laxes.Children.Visible='off';
            hold(obj.laxes, 'on');
            set(obj.laxes, 'LineWidth', obj.axes1.LineWidth,...
                'TickDir', obj.axes1.TickDir, 'Box', obj.axes1.Box,...
                'XLim', obj.axes1.XLim, 'YLim', obj.axes1.YLim,...
            ...
            for i = 1:numLine
                ...
                line(pos1, pos2, 'Parent', obj.laxes, 'Color', obj.boxLineColor,...
